...
class OriginStory extends Component {
  render() {
    return (
      <div className="content">
        <h2>Jímavá story o původu guildy</h2>
        <br />
        <Panel className="story">
          <p>
            ...
            oblíbeného krajského tabáku Drsoň.
          </p>
          <p>
          ...
          <p>
            ...
            mladí vidláci, čerstvě na své cestě za dobrodružstvím. Hobitínský
            ...
            morální výhrady proti likvidaci divokého ptactva". Smoulinka, často
            mrtvá - tedy talentovaná - nekromantka, zrovna tradičně brutálně
            ...
            by měl mít možnost kouzlit tak rychle, jak dokáže!" "No um.. jistě!
            A umm..." "Omlouvám se, nechtěl jsem vás přerušovat, znělo to
            opravdu velkolepě.", ozval se tichý hlas za jejich zády.
            "Krucinálfagot to jsem se lek, tady ještě někdo je?!", ulevil si El:
            "Co tu sakra ve tmě děláte, člověče?". "Svačím. Anna Fuin. Těší mě,
            ...
            či druhé straně". "Umm.. Dobrá tedy! A pojmenujeme se... třeba
            támhle podle té jeskynní kresby na železné žíle, železní vlci!".
            "Železní vlci!" "Železní vlci!" "ooOoOO OooO!".
          </p>
          <p>
            Netrvalo dlouho a samozvaná skupinka se rozrostla o další mladé
            dobrodruhy a vystavěla u osudové skály srub. Jednoho dne si pak z
            díry udělala doupě smečka divokých vlků, bez ohledu na blízkost
            lidí, což vzali jako dobré znamení toho, že je dal dohromady sám
            osud.
          </p>
          <p>
            Onu kresbu vlka od jejich prvního setkání na stěně nikdo nespatřil.
          </p>
          <p>
            Souvisela snad ona kresba nějak s předchozími událostmi, jen proto,
            že to byl vlk? Dala skupinku dohromady náhoda, nebo snad nějaká
            napřirozená bytost? Nebo dokonce osud? Nebyl to nakonec Jan Tleskač?
            Kdo ví.
          </p>
        </Panel>
      </div>
